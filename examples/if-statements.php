...
//3. NOT Operator (!)
//The ! operator inverts the result of a condition
//(i.e., if a condition is true, ! will make it false).
...
//
//These examples show how logical operators can control program
//flow based on multiple conditions.